    ...
    <div class="auth">
      <div id="content">
        ...
        <div id="container">
          ...
          <form
            v-if="!loginForm && !showPasswordForm"
          ...
          >
            ...
            <input
              ...
              required
            />
            <span id="goToLogin" @click="swapLoginForm()"> Volver </span>
            <br />
            <button type="submit" name="resetPassButton">
          ...
          <form v-if="showPasswordForm" @submit.prevent="setPasswordForm()">
            ...
            <input
              ...
              required
            />
            <button type="submit" name="resetPassConfirmButton">
...
const resetPasswordForm = () => {
  ...
  setRestorePassword({ email: email.value })
    .then(() => {
      alert.addAlert(
        "Se ha enviado un correo a la cuenta indicada. Para restablecer la contraseña, siga las instrucciones.",
        "success"
      );
      swapLoginForm();
    })
