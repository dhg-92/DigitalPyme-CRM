package opensuite.crm.users.domain.repository;

import opensuite.crm.users.domain.User;
import opensuite.crm.users.infrastructure.repository.SpringDataUserRepository;
import opensuite.crm.users.infrastructure.repository.UserEntity;
